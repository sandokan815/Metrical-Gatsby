...
export default function Solutions({ location }) {
  ...
  var content1 = query.allMarkdownRemark.edges.filter(
    (data) => data.node.frontmatter.path == "/solutions"
  );
  ...
  return (
    <div className="Solutions">
      ...
      <Header
        title={content.soution_header_title}
        btn={content.soution_header_button_text}
      />
      <Three
